...
% Нереляционные СУБД разделяют на 4 класса
...
годах. Каналы естественным образом реализуют философию
...
Для разработки библиотеки был выбран язык \verb|C++| из-за
...
\begin{enumerate}
  ...
  \item Широко известные инструменты для тестирования корректности и
        ...
        \verb|GoogleTest| для юнит-тестов и
        \verb|google/benchmark| для микробенчмарков.
