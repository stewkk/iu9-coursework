...
Механизмы обмена данными между процессами в Linux разделяют на 3 большие
категории по функциональному предназначению.\cite{kerrisk2010linux}

\begin{itemize}
  \item Коммуникационные (\ref{fig:communication_ipc_taxonomy}): фокусируются на
